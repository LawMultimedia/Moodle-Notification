...
// Attendance requirements notification
	$('.sectionname').before('<div class="container"><div class="modal fade" id="attNotification" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background:#006dae"><h4 class="modal-title text-white">Attendance expectations</h4><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div><div class="modal-body"><p>Students are expected to attend and participate in at least 80% of classes in this unit. All the evidence suggests that student academic success is greatly impacted by class attendance and participation.
</p></div><div class="modal-footer"><button type="button" class="btn btn-danger btn-block" data-dismiss="modal">Close</button></div></div></div></div></div>');
